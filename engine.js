...
var TitleScreen = function TitleScreen(title,subtitle, about, callback) {
  var up = false;
  ...
  this.draw = function(ctx) {
    ...
    ctx.fillText(subtitle,Game.width/2,Game.height/2 + 70);

    ctx.font = "15px bangers";
    ctx.fillText(about,Game.width/2,Game.height/2 + 35);
  };
};
